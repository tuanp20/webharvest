...
Extracts products from Merchize.
"""
...
class MerchizeExtractor(BaseSiteExtractor):
    """Merchize Extractor (Tầng 1 - Static)."""

    SITE_DOMAIN = "merchize.com"
    FETCHER_TYPE = "static"
    ...
    def extract_listing(self, html: str, url: str) -> list[str]:
        ...
        for a in soup.find_all("a", href=True):
            href = a["href"]
            if "/shop/" in href or "/product/" in href or "-pod-" in href:
