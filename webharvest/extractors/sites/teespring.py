...
Extracts products from TeeSpring (Spring).
"""
...
class TeeSpringExtractor(BaseSiteExtractor):
    """TeeSpring Extractor (Tầng 3 - Stealth)."""

    SITE_DOMAIN = "teespring.com"
    ...
    def extract_listing(self, html: str, url: str) -> list[str]:
        ...
        for a in soup.find_all("a", href=True):
            href = a["href"]
            if "/listing/" in href or "/product/" in href:
