...
Extracts products from Society6.
"""
...
class Society6Extractor(BaseSiteExtractor):
    """Society6 Extractor (Tầng 3 - Stealth)."""

    SITE_DOMAIN = "society6.com"
    ...
    def extract_product(self, html: str, url: str) -> Optional[ProductData]:
        ...
        category = self._extract_category(soup) or "Custom Art"
    ...
    def extract_listing(self, html: str, url: str) -> list[str]:
        ...
        for a in soup.find_all("a", href=True):
            href = a["href"]
            if "/product/" in href or "/s?" in href:
