"""Spreadshirt Extractor.

Extracts products from Spreadshirt.
"""
...
class SpreadshirtExtractor(BaseSiteExtractor):
    """Spreadshirt Extractor (Tầng 1 - Static)."""

    SITE_DOMAIN = "spreadshirt.com"
    FETCHER_TYPE = "static"
    ...
    def extract_listing(self, html: str, url: str) -> list[str]:
        ...
        for a in soup.find_all("a", href=True):
            href = a["href"]
            if "-A" in href or "/shop/" in href or "/product/" in href:
