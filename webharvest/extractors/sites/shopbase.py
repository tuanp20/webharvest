...
Extracts products from ShopBase.
"""
...
class ShopBaseExtractor(BaseSiteExtractor):
    """ShopBase Extractor (Tầng 2 - Dynamic)."""

    SITE_DOMAIN = "shopbase.com"
    FETCHER_TYPE = "dynamic"
    RATE_LIMIT = {"rate": 0.3, "burst": 2}
    ...
    def extract_product(self, html: str, url: str) -> Optional[ProductData]:
        ...
        category = self._extract_category(soup) or "E-commerce Product"
