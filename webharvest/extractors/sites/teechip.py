...
Extracts products from TeeChip.
"""
...
class TeeChipExtractor(BaseSiteExtractor):
    """TeeChip Extractor (Tầng 1 - Static)."""

    SITE_DOMAIN = "teechip.com"
    FETCHER_TYPE = "static"
    ...
    def extract_product(self, html: str, url: str) -> Optional[ProductData]:
        ...
        category = self._extract_category(soup) or "Apparel"
    ...
    def extract_listing(self, html: str, url: str) -> list[str]:
        ...
        for a in soup.find_all("a", href=True):
            href = a["href"]
            # TeeChip typical campaigns/products urls
            if "/campaign/" in href or "/store/" in href:
